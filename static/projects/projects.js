...
angular.module('angularApp.projects', ['ngRoute'])
...
.controller('ProjectsCtrl', ['$scope', '$http', '$location', '$rootScope', '$routeParams', function ($scope, $http, $location, $rootScope, $routeParams) {
